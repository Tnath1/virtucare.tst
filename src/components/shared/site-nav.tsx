  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur">
      <nav className="mx-auto flex h-16 w-full max-w-5xl items-center justify-between px-4 sm:px-6">
        ...
        <button
          type="button"
          className="relative z-[70] flex h-10 w-10 items-center justify-center rounded-md border border-slate-200 bg-white text-slate-900 shadow-sm transition hover:border-teal-600 hover:text-teal-700 sm:hidden"
      ...
      <button
        ...
        className={cn(
          "fixed inset-0 z-[55] bg-slate-900/20 opacity-0 backdrop-blur-sm transition-opacity duration-200 sm:hidden",
          isMenuOpen
